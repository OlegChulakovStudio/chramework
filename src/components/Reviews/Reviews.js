...
class Reviews extends Component {
  ...
  render() {
    ...
    const arrowPrevStyle = classNames(
      "Reviews__navigation-item Reviews__navigation-item_prev",
      {
        "Reviews__navigation-item_hide": this.state.hideArrows
      }
    );
    const arrowNextStyle = classNames(
      "Reviews__navigation-item Reviews__navigation-item_next",
      {
        "Reviews__navigation-item_hide": this.state.hideArrows
      }
    );
    ...
    return (
      <div {...rest} className={classes}>
                ...
                <div className="Reviews__inner">
                  <div className="Reviews__top">
                    <div className="Reviews__info">
                      ...
                      <div className="Reviews__info-content">
        ...
        <div className="Reviews__navigation">
          {!firstSlide && (
            <div
              ref={this.getLeftArrowNode}
              onClick={this.slidePrev}
              className={arrowPrevStyle}
            >
          ...
          {!lastSlide && (
            <div
              ref={this.getRigthArrowNode}
              onClick={this.slideNext}
              className={arrowNextStyle}
            >

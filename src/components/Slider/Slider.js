    ...
    return (
      <div {...rest} className={sliderClass}>
        ...
        >
          ...
          {!firstSlide && (
            <div className={arrowPrevStyle} onClick={this.slidePrev}>
              <ArrowIcon className="Slider__navArea-icon Slider__navArea-icon_left" />
            </div>
          )}
          {!lastSlide && (
            <div className={arrowNextStyle} onClick={this.slideNext}>
              <ArrowIcon className="Slider__navArea-icon Slider__navArea-icon_right" />
            </div>
          )}
        </div>
            ...
            <div className="Slider__content Slider__content--active">
              <TextGroup
                title={
                  description
                    ? description.label
                    : slides[indexActive].description.label
                }
                subtitle={
                  description
                    ? description.text
                    : slides[indexActive].description.text
                }
                mod="boldTitle"
              />
            </div>
